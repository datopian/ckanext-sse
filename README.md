...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.sse.some_setting = some_default_value
...
## Releasing a new version of ckanext-sse

If ckanext-sse should be available on PyPI you can follow these steps to publish a new version:
