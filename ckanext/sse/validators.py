...
def coverage_json_object(value, context):
    ...
    def _coverage_validator(value):
        ...
        try: 
            ...
            raise Invalid(_(f"Invalid JSON object. Please provide JSON in the correct format. {e.message}"))
    ...
    if isinstance(value, six.string_types):
        ...
        raise Invalid(_("Invalid JSON object. Please provide JSON in the correct format."))
